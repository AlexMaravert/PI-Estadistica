...
#para generar numero aleatorios es sample
...
x1<-pnorm(7, mean=7.5, sd=1.86, lower.tail = FALSE)
x1*100
...
# Las calificaciones de ingreso a la escuela Maravert SA de CV 
# se ajustan a una distribución Normal, 
# donde la media de la prueba es 85 y 
# la desviacion estándar es 24 
# ¿Cual es el porcentaje de estudiantes 
# con un puntaje mayor a 84 en el examen?

x<-pnorm(100, mean=72, sd=15.2, lower.tail = FALSE)
x*100
x